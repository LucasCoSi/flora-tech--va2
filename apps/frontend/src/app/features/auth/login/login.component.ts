        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50">
          <div class="px-8 pt-12 pb-8">
            <div class="text-center mb-10">
              ...
              <p class="text-slate-500 mt-2">Faça login para gerenciar suas estufas</p>
            </div>
              ...
              <div class="space-y-1">
                ...
                <div class="relative">
                  ...
                  <input 
                    ...
                    class="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl bg-white/50 focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-colors"
